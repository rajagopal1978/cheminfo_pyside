...
class BatchProcessorWidget(QWidget):
    """Widget for process multiple molecules in batch mode"""
    ...
    def setup_ui(self):
        ...
        subtitle = QLabel("Process multiple molecules in batch mode")
    ...
    def process(self):
        ...
        try:
            output = f"<h3 style='color: #1e40af;'>⚡ Batch Processor</h3>"
