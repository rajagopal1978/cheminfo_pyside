...
class ClusteringEngineWidget(QWidget):
    """Widget for cluster molecules by similarity"""
    ...
    def setup_ui(self):
        ...
        # Title
        title = QLabel("🔗 Clustering Engine")
        title.setStyleSheet(self.theme_manager.get_title_style("large"))
        layout.addWidget(title)

        subtitle = QLabel("Cluster molecules by similarity")
        ...
        # Process button
        self.process_btn = QPushButton("🔗 Cluster Molecules")
    ...
    def process(self):
        ...
        try:
            output = f"<h3 style='color: #1e40af;'>🔗 Clustering Engine</h3>"
