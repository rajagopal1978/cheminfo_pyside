...
class LeadOptimizerWidget(QWidget):
    """Widget for optimize lead compounds for drug development"""
    ...
    def setup_ui(self):
        ...
        # Title
        title = QLabel("🎯 Lead Optimizer")
        title.setStyleSheet(self.theme_manager.get_title_style("large"))
        layout.addWidget(title)

        subtitle = QLabel("Optimize lead compounds for drug development")
        ...
        # Process button
        self.process_btn = QPushButton("🎯 Optimize Lead")
    ...
    def process(self):
        ...
        try:
            output = f"<h3 style='color: #1e40af;'>🎯 Lead Optimizer</h3>"
