...
class QuantumDescriptorsWidget(QWidget):
    """Widget for calculate quantum chemical descriptors"""
    ...
    def setup_ui(self):
        ...
        # Title
        title = QLabel("⚛️ Quantum Descriptors")
        title.setStyleSheet(self.theme_manager.get_title_style("large"))
        layout.addWidget(title)

        subtitle = QLabel("Calculate quantum chemical descriptors")
        ...
        # Process button
        self.process_btn = QPushButton("⚛️ Calculate Quantum")
    ...
    def process(self):
        ...
        try:
            output = f"<h3 style='color: #1e40af;'>⚛️ Quantum Descriptors</h3>"
