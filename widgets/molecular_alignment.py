...
class MolecularAlignmentWidget(QWidget):
    """Widget for align molecules in 3d space"""
    ...
    def setup_ui(self):
        ...
        # Title
        title = QLabel("📐 Molecular Alignment")
        title.setStyleSheet(self.theme_manager.get_title_style("large"))
        layout.addWidget(title)

        subtitle = QLabel("Align molecules in 3D space")
        ...
        # Process button
        self.process_btn = QPushButton("📐 Align Molecules")
    ...
    def process(self):
        ...
        try:
            output = f"<h3 style='color: #1e40af;'>📐 Molecular Alignment</h3>"
