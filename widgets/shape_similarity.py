...
class ShapeSimilarityWidget(QWidget):
    """Widget for calculate 3d shape similarity"""
    ...
    def setup_ui(self):
        ...
        # Title
        title = QLabel("🔷 Shape Similarity")
        title.setStyleSheet(self.theme_manager.get_title_style("large"))
        layout.addWidget(title)

        subtitle = QLabel("Calculate 3D shape similarity")
        ...
        # Process button
        self.process_btn = QPushButton("🔷 Calculate Shape Similarity")
    ...
    def process(self):
        ...
        try:
            output = f"<h3 style='color: #1e40af;'>🔷 Shape Similarity</h3>"
