...
class ToxicityPredictorWidget(QWidget):
    """Widget for predict molecular toxicity and safety profiles"""
    ...
    def setup_ui(self):
        ...
        # Title
        title = QLabel("⚠️ Toxicity Predictor")
        title.setStyleSheet(self.theme_manager.get_title_style("large"))
        layout.addWidget(title)

        subtitle = QLabel("Predict molecular toxicity and safety profiles")
        ...
        # Process button
        self.process_btn = QPushButton("⚠️ Predict Toxicity")
    ...
    def process(self):
        ...
        try:
            output = f"<h3 style='color: #1e40af;'>⚠️ Toxicity Predictor</h3>"
