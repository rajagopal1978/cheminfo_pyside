...
class SaltStripperWidget(QWidget):
    """Widget for remove salts and counterions from molecules"""
    ...
    def setup_ui(self):
        ...
        # Title
        title = QLabel("🧂 Salt Stripper")
        title.setStyleSheet(self.theme_manager.get_title_style("large"))
        layout.addWidget(title)

        subtitle = QLabel("Remove salts and counterions from molecules")
        ...
        # Process button
        self.process_btn = QPushButton("🧂 Strip Salts")
    ...
    def process(self):
        ...
        try:
            output = f"<h3 style='color: #1e40af;'>🧂 Salt Stripper</h3>"
