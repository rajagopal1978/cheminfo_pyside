...
class SubstructureSearchWidget(QWidget):
    """Widget for search for molecular substructures using smarts"""
    ...
    def setup_ui(self):
        ...
        # Title
        title = QLabel("🔎 Substructure Search")
        title.setStyleSheet(self.theme_manager.get_title_style("large"))
        layout.addWidget(title)

        subtitle = QLabel("Search for molecular substructures using SMARTS")
        ...
        # Process button
        self.process_btn = QPushButton("🔎 Search Substructures")
    ...
    def process(self):
        ...
        try:
            output = f"<h3 style='color: #1e40af;'>🔎 Substructure Search</h3>"
