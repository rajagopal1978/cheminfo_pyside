...
class DatabaseCuratorWidget(QWidget):
    """Widget for curate and manage molecular databases"""
    ...
    def setup_ui(self):
        ...
        # Title
        title = QLabel("🗄️ Database Curator")
        title.setStyleSheet(self.theme_manager.get_title_style("large"))
        layout.addWidget(title)

        subtitle = QLabel("Curate and manage molecular databases")
        ...
        # Process button
        self.process_btn = QPushButton("🗄️ Curate Database")
    ...
    def process(self):
        ...
        try:
            output = f"<h3 style='color: #1e40af;'>🗄️ Database Curator</h3>"
