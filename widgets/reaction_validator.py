...
class ReactionValidatorWidget(QWidget):
    """Widget for validate chemical reaction feasibility"""
    ...
    def setup_ui(self):
        ...
        # Title
        title = QLabel("✅ Reaction Validator")
        title.setStyleSheet(self.theme_manager.get_title_style("large"))
        layout.addWidget(title)

        subtitle = QLabel("Validate chemical reaction feasibility")
        ...
        # Process button
        self.process_btn = QPushButton("✅ Validate Reaction")
    ...
    def process(self):
        ...
        try:
            output = f"<h3 style='color: #1e40af;'>✅ Reaction Validator</h3>"
