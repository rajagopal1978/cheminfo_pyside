...
class DiversityPickerWidget(QWidget):
    """Widget for select diverse subset of molecules"""
    ...
    def setup_ui(self):
        ...
        # Title
        title = QLabel("🎲 Diversity Picker")
        title.setStyleSheet(self.theme_manager.get_title_style("large"))
        layout.addWidget(title)

        subtitle = QLabel("Select diverse subset of molecules")
        ...
        # Process button
        self.process_btn = QPushButton("🎲 Pick Diverse Set")
    ...
    def process(self):
        ...
        try:
            output = f"<h3 style='color: #1e40af;'>🎲 Diversity Picker</h3>"
