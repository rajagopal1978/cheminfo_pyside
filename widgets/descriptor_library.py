...
class DescriptorLibraryWidget(QWidget):
    """Widget for calculate comprehensive molecular descriptors"""
    ...
    def setup_ui(self):
        ...
        # Title
        title = QLabel("📚 Descriptor Library")
        title.setStyleSheet(self.theme_manager.get_title_style("large"))
        layout.addWidget(title)

        subtitle = QLabel("Calculate comprehensive molecular descriptors")
        ...
        # Process button
        self.process_btn = QPushButton("📚 Calculate Descriptors")
    ...
    def process(self):
        ...
        try:
            output = f"<h3 style='color: #1e40af;'>📚 Descriptor Library</h3>"
