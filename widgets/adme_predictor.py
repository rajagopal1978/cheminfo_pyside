...
class ADMEPredictorWidget(QWidget):
    """Widget for predict adme properties for drug candidates"""
    ...
    def setup_ui(self):
        ...
        # Title
        title = QLabel("💉 ADME Predictor")
        title.setStyleSheet(self.theme_manager.get_title_style("large"))
        layout.addWidget(title)

        subtitle = QLabel("Predict ADME properties for drug candidates")
        ...
        # Process button
        self.process_btn = QPushButton("💉 Predict ADME")
    ...
    def process(self):
        ...
        try:
            output = f"<h3 style='color: #1e40af;'>💉 ADME Predictor</h3>"
