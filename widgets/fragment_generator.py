...
class FragmentGeneratorWidget(QWidget):
    """Widget for generate molecular fragments for analysis"""
    ...
    def setup_ui(self):
        ...
        # Title
        title = QLabel("🧩 Fragment Generator")
        title.setStyleSheet(self.theme_manager.get_title_style("large"))
        layout.addWidget(title)

        subtitle = QLabel("Generate molecular fragments for analysis")
        ...
        # Process button
        self.process_btn = QPushButton("🧩 Generate Fragments")
    ...
    def process(self):
        ...
        try:
            output = f"<h3 style='color: #1e40af;'>🧩 Fragment Generator</h3>"
