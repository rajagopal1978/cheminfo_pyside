...
class PharmacophoreDetectorWidget(QWidget):
    """Widget for detect pharmacophore features"""
    ...
    def setup_ui(self):
        ...
        # Title
        title = QLabel("🎯 Pharmacophore Detector")
        title.setStyleSheet(self.theme_manager.get_title_style("large"))
        layout.addWidget(title)

        subtitle = QLabel("Detect pharmacophore features")
        ...
        # Process button
        self.process_btn = QPushButton("🎯 Detect Pharmacophore")
    ...
    def process(self):
        ...
        try:
            output = f"<h3 style='color: #1e40af;'>🎯 Pharmacophore Detector</h3>"
