...
class MatchedPairsWidget(QWidget):
    """Widget for find matched molecular pairs"""
    ...
    def setup_ui(self):
        ...
        # Title
        title = QLabel("👯 Matched Pairs")
        title.setStyleSheet(self.theme_manager.get_title_style("large"))
        layout.addWidget(title)

        subtitle = QLabel("Find matched molecular pairs")
        ...
        # Process button
        self.process_btn = QPushButton("👯 Find Pairs")
    ...
    def process(self):
        ...
        try:
            output = f"<h3 style='color: #1e40af;'>👯 Matched Pairs</h3>"
