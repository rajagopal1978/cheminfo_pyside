...
class RGroupDecompositionWidget(QWidget):
    """Widget for decompose molecules into r-groups"""
    ...
    def setup_ui(self):
        ...
        # Title
        title = QLabel("🔧 R-Group Decomposition")
        title.setStyleSheet(self.theme_manager.get_title_style("large"))
        layout.addWidget(title)

        subtitle = QLabel("Decompose molecules into R-groups")
        ...
        # Process button
        self.process_btn = QPushButton("🔧 Decompose R-Groups")
    ...
    def process(self):
        ...
        try:
            output = f"<h3 style='color: #1e40af;'>🔧 R-Group Decomposition</h3>"
